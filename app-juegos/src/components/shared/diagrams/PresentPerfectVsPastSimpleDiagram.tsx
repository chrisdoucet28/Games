...
export function PresentPerfectVsPastSimpleDiagram({ variant, accentColor = "#2563EB" }: { variant: "screen" | "print"; accentColor?: string }) {
  ...
  return (
    ...
    >
      {/* No mascots on the diagram itself — kept as a clean, focused teaching visual. Mascot
          personality lives in the page chrome around it (MascotDuo, header/CTA) instead. */}
      {isScreen && (
        <div
          style={{
