export const TOPIC_LIBRARY = {
  ...
  irregular_verbs: {
    ...
    hotPotatoPrompts: [
      {prompt:"Past simple of 'go'?", answer:"went"},
      {prompt:"Past simple of 'eat'?", answer:"ate"},
      {prompt:"Past simple of 'see'?", answer:"saw"},
      {prompt:"Past simple of 'buy'?", answer:"bought"},
      {prompt:"Past simple of 'take'?", answer:"took"},
      {prompt:"Past simple of 'break'?", answer:"broke"},
      {prompt:"Past simple of 'fall'?", answer:"fell"},
      {prompt:"Past simple of 'drive'?", answer:"drove"},
      {prompt:"Past simple of 'speak'?", answer:"spoke"},
      {prompt:"Past simple of 'teach'?", answer:"taught"},
      {prompt:"Past simple of 'sleep'?", answer:"slept"},
      {prompt:"Past simple of 'lose'?", answer:"lost"},
      {prompt:"Past simple of 'forget'?", answer:"forgot"},
      {prompt:"Past simple of 'choose'?", answer:"chose"},
      {prompt:"Past simple of 'run'?", answer:"ran"},
      {prompt:"Past participle of 'see'?", answer:"seen"},
      {prompt:"Past participle of 'write'?", answer:"written"},
      {prompt:"Past participle of 'eat'?", answer:"eaten"},
      {prompt:"Past participle of 'grow'?", answer:"grown"},
      {prompt:"Past participle of 'steal'?", answer:"stolen"},
    ],
    auctionSentences: [
  ...
  present_perfect: {
    ...
    hotPotatoPrompts: [
      {prompt:"'I have ___ (go) to Japan.' What is the past participle?", answer:"been"},
      ...
      {prompt:"Present perfect of 'eat'?", answer:"has/have eaten"},
      {prompt:"Present perfect of 'write'?", answer:"has/have written"},
      {prompt:"Present perfect of 'see'?", answer:"has/have seen"},
      {prompt:"'Have you ever ___?' — what kind of question is this?", answer:"life experience question"},
      ...
      {prompt:"Present perfect with 'just' — near past or distant past?", answer:"very near / just completed"},
      {prompt:"'I haven't finished ___.' (yet/already/just)", answer:"yet"},
      {prompt:"Name one key word that signals present perfect.", answer:"(free — already, just, yet, ever, never, since, for)"},
      {prompt:"'Did you ever…?' is this correct for life experience?", answer:"no — use 'Have you ever…?'"},
  ...
  first_conditional: {
    ...
    hotPotatoPrompts: [
      {prompt:"Which tense goes in the if-clause?", answer:"present simple"},
      {prompt:"Which structure goes in the main clause?", answer:"will + bare infinitive"},
      ...
      {prompt:"Can you put 'will' in the if-clause?", answer:"no"},
      {prompt:"'If she calls, I ___ answer.' (will/would)", answer:"will"},
      {prompt:"Is first conditional real or imaginary?", answer:"real / likely"},
      ...
      {prompt:"'Will + infinitive or will + have?'  — 'She'll ___ to retake it.'", answer:"have"},
      ...
      {prompt:"What does first conditional express?", answer:"a real, possible future situation"},
  ...
  past_simple: {
    ...
    hotPotatoPrompts: [
      ...
      {prompt:"'She played' — is this regular or irregular?", answer:"regular"},
      {prompt:"'She went' — is this regular or irregular?", answer:"irregular"},
      {prompt:"After 'didn't', what form of the verb?", answer:"base form (infinitive)"},
      {prompt:"After 'did' in a question, what form?", answer:"base form (infinitive)"},
      {prompt:"Past simple of 'am/is'?", answer:"was"},
      {prompt:"Past simple of 'are'?", answer:"were"},
      ...
      {prompt:"Past simple of 'write'?", answer:"wrote"},
      {prompt:"Past simple of 'come'?", answer:"came"},
  ...
  passive_simple: {
    ...
    hotPotatoPrompts: [
      ...
      {prompt:"'Was going to be built' — is this passive?", answer:"yes — going to passive"},
  ...
  passive_complex: {
    ...
    hotPotatoPrompts: [
      ...
      {prompt:"'It is said that he lied.' Reporting passive — true or false?", answer:"true"},
      ...
      {prompt:"'The suspect is being questioned.' Is this past or present?", answer:"present continuous passive"},
      ...
      {prompt:"'The project should be finished.' Is this a command?", answer:"no — a modal passive"},
      {prompt:"Complex passive vs simple passive — what's the difference?", answer:"complex uses more auxiliary verbs"},
    ],
    auctionSentences: [
  ...
  causative_verbs: {
    ...
    hotPotatoPrompts: [
      {prompt:"'Have + object + ___' for a service done for you.", answer:"past participle"},
      {prompt:"'She had her hair ___.' (cut or to cut?)", answer:"cut (past participle)"},
      {prompt:"'Make' + object + ___ infinitive.", answer:"bare (no 'to')"},
      {prompt:"'Let' + object + ___ infinitive.", answer:"bare (no 'to')"},
      {prompt:"'Get + person + ___' to do something.", answer:"to-infinitive"},
      ...
      {prompt:"'The film made me ___.' (cry or to cry?)", answer:"cry (bare infinitive)"},
      {prompt:"'My boss doesn't let us ___ late.' (leave or leaving?)", answer:"leave"},
      {prompt:"'Get + object + past participle' — give an example.", answer:"I got my nails done."},
      {prompt:"'Have' vs 'get' — which is more informal?", answer:"get"},
      {prompt:"'Make' vs 'let' — which shows permission?", answer:"let"},
      {prompt:"'Make' vs 'let' — which shows force?", answer:"make"},
      ...
      {prompt:"'He had us ___ the whole report.' (redo or to redo?)", answer:"redo (bare infinitive with 'have')"},
  ...
  get_used_to: {
    ...
    hotPotatoPrompts: [
      {prompt:"'Used to' + ___ infinitive (bare or to-infinitive?)", answer:"bare infinitive"},
      {prompt:"'Be used to' + ___", answer:"-ing (gerund)"},
      {prompt:"'Get used to' describes a ___ or a final state?", answer:"process"},
      {prompt:"'I used to live here.' Do I live here now?", answer:"no"},
      {prompt:"'I am used to waking up early.' Is this easy for me now?", answer:"yes"},
      ...
      {prompt:"'Be used to' — is this about the past or present?", answer:"present (current familiarity)"},
      ...
      {prompt:"'I've got used to working from home.' — present perfect or past simple?", answer:"present perfect"},
      {prompt:"Name one thing you are used to now that felt strange at first.", answer:"(free answer)"},
      {prompt:"'They would visit every Sunday.' Is this similar to 'used to'?", answer:"yes, for habits (not states)"},
      {prompt:"'Used to' can describe past ___ and past ___.", answer:"habits and states"},
      {prompt:"Can 'would' replace 'used to' for states? Example: 'I would be shy.'", answer:"no — only for repeated actions"},
      {prompt:"Make a sentence with 'get used to'.", answer:"(free — I'm getting used to the cold.)"},
      {prompt:"'She used to ___ (love) coffee.' Complete it.", answer:"love (bare infinitive)"},
    ],
    auctionSentences: [
  ...
  inversion: {
    ...
    hotPotatoPrompts: [
      ...
      {prompt:"After inversion with 'have', what comes first?", answer:"have + subject + past participle"},
      {prompt:"Name a negative adverb that triggers inversion.", answer:"(free — never, rarely, seldom, hardly, scarcely)"},
  ...
  mixed_conditionals: {
    ...
    hotPotatoPrompts: [
      ...
      {prompt:"Which conditional mixes times?", answer:"mixed conditional"},
      {prompt:"Past cause + present result — if-clause uses which tense?", answer:"past perfect"},
      {prompt:"Present state + past result — if-clause uses which tense?", answer:"past simple / were"},
      {prompt:"'If only I ___ left sooner...' — regret form?", answer:"had left"},
      {prompt:"Difference: 'would be' vs 'would have been' in mixed conditionals?", answer:"'would be' = present result; 'would have been' = past result"},
      ...
      {prompt:"'No 'would' in the if-clause' — true or false?", answer:"true"},
      {prompt:"'If she were more confident' — is this past-to-past or present-to-past?", answer:"present-to-past"},
      {prompt:"'If I had known, I would tell you now.' — correct?", answer:"no — 'I would have told you' (or 'I would tell you' — depends on time)"},
      {prompt:"Name one signal that the result clause refers to present.", answer:"would + base verb (no 'have')"},
      {prompt:"Name one signal that the result clause refers to past.", answer:"would + have + past participle"},
  ...
  making_questions: {
    ...
    hotPotatoPrompts: [
      ...
      {prompt:"After 'does', which verb form?", answer:"base form (no -s)"},
      {prompt:"After 'did', which verb form?", answer:"base form"},
      {prompt:"'Who called you?' — subject or object question?", answer:"subject question (no did)"},
      {prompt:"'Who did you call?' — subject or object question?", answer:"object question"},
  ...
  second_conditional: {
    ...
    hotPotatoPrompts: [
      {prompt:"Second conditional if-clause uses which tense?", answer:"past simple"},
      ...
      {prompt:"'If I were you' — what kind of advice?", answer:"indirect / polite advice"},
  ...
  modal_verbs: {
    ...
    hotPotatoPrompts: [
      ...
      {prompt:"Modal verbs take bare ___ (no 'to').", answer:"infinitive"},
      {prompt:"'You ___ see a doctor.' (strong advice)", answer:"should / must"},
      {prompt:"Difference: mustn't vs don't have to?", answer:"mustn't = forbidden; don't have to = not necessary"},
      ...
      {prompt:"Name two modals expressing possibility.", answer:"might / could / may"},
      {prompt:"Name two modals expressing obligation.", answer:"must / have to"},
      {prompt:"'Can't' for deduction means…?", answer:"it is logically impossible"},
