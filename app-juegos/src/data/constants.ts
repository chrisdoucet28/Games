...
export const GAME_MODES: GameMode[] = [
  ...
  { id: "bounty",    name: "Bounty Board", icon: "🤠",  desc: "One wanted sentence per round — get it wrong and it becomes an open bounty any OTHER team can claim by fixing it, worth more every time it's missed", color: "#B45309", tag: "Full sentences, written or spoken · escalating stakes" },
  ...
  { id: "relay",     name: "Word Relay", icon: "📱",  desc: "One word live at a time — a team's own phone (or the shared screen) faces out so everyone nearby can shout clues. Guess it and the turn passes instantly to the next team", color: "#0D9488", tag: "Nonstop improvised talking · no clock" },
