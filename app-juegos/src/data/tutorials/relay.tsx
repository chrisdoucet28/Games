...
export const RELAY_TUTORIAL_STEPS: TutorialStep[] = [
  ...
  {
    narration: "Guessed it? The team scores 10 points, the word is REVEALED, and the asker sits down — a teammate swaps in with a brand new word. Use up all 15 of your own questions without guessing and the next teammate swaps in anyway, so nobody gets stuck.",
    visual: (
      <div style={{ textAlign: "center" }}>
  ...
  {
    narration: "The teacher picks how many people are on each team before the game starts — every one of them gets their own turn at the front, 15 questions each. The team that works out the most words before everyone's had a turn wins!",
    visual: (
      <div style={{ textAlign: "center" }}>
        <div style={{ fontSize: "20px" }}>🏁</div>
        <div style={{ fontSize: "11px", fontWeight: 700, color: "#374151" }}>15 questions per person — most words wins</div>
      </div>
    ),
  },
];
